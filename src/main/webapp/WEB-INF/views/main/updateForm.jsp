...
<body>
	<div class="container" align="center">
		...
		<form action="${path }/update.do" method="post" enctype="multipart/form-data"
			...
			<table class="table table-bordered table-hover">
				...
				<tr>
					...
					<td><input type="file" name="file"> <img alt=""
						src="resources/images/${member.memberPhoto }" width="100"></td>
				</tr>
				<tr>
